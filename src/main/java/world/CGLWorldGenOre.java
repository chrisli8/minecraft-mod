...
public class CGLWorldGenOre implements IWorldGenerator {
	...
	private void generateSurface(Random random, int chunkX, int chunkZ, World world) {
		addOre(ModBlocks.amethystOre, Blocks.stone, random, world, chunkX, chunkZ, 4, 32, 1, 5, 3 + random.nextInt(5));
		addOre(ModBlocks.rubyOre, Blocks.stone, random, world, chunkX, chunkZ, 4, 32, 1, 5, 3 + random.nextInt(5));
		addOre(ModBlocks.saphireOre, Blocks.stone, random, world, chunkX, chunkZ, 4, 32, 1, 5, 3 + random.nextInt(5));
	}
