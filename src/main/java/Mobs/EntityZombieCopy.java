...
public class EntityZombieCopy extends EntityMob
{
    ...
    public EntityZombieCopy(World p_i1745_1_)
    {
        super(p_i1745_1_);
...
//            {
//                EntityZombieCopy EntityZombieCopy;
//                if (summonAid.customSummonedAid != null && summonAid.getResult() == Result.ALLOW)
//                {
//                     EntityZombieCopy = summonAid.customSummonedAid;
//                }
//                else
//                {
//                    EntityZombieCopy = new EntityZombieCopy(this.worldObj);
//                }
//
//                for (int l = 0; l < 50; ++l)
//                {
...
//                    {
//                        EntityZombieCopy.setPosition((double)i1, (double)j1, (double)k1);
//
//                        if (this.worldObj.checkNoEntityCollision(EntityZombieCopy.boundingBox) && this.worldObj.getCollidingBoundingBoxes(EntityZombieCopy, EntityZombieCopy.boundingBox).isEmpty() && !this.worldObj.isAnyLiquid(EntityZombieCopy.boundingBox))
//                        {
//                            this.worldObj.spawnEntityInWorld(EntityZombieCopy);
//                            if (entitylivingbase != null) EntityZombieCopy.setAttackTarget(entitylivingbase);
//                            EntityZombieCopy.onSpawnWithEgg((IEntityLivingData)null);
...
//                            EntityZombieCopy.getEntityAttribute(field_110186_bp).applyModifier(new AttributeModifier("Zombie reinforcement callee charge", -0.05000000074505806D, 0));
//                            break;
//                        }
//                    }
//                }
//            }
    ...
    public void onKillEntity(EntityLivingBase p_70074_1_)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && p_70074_1_ instanceof EntityVillager)
        {
            ...
            EntityZombieCopy EntityZombieCopy = new EntityZombieCopy(this.worldObj);
            EntityZombieCopy.copyLocationAndAnglesFrom(p_70074_1_);
            this.worldObj.removeEntity(p_70074_1_);
            EntityZombieCopy.onSpawnWithEgg((IEntityLivingData)null);
            EntityZombieCopy.setVillager(true);

            if (p_70074_1_.isChild())
            {
                EntityZombieCopy.setChild(true);
            }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        {
            p_110161_1_1 = new EntityZombieCopy.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityZombieCopy.GroupData)
        {
            EntityZombieCopy.GroupData groupdata = (EntityZombieCopy.GroupData)p_110161_1_1;
