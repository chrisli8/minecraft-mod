...
public class RubyIronSword extends ItemSword {
	public String name = "swordIronRuby";
	
	public RubyIronSword(Item.ToolMaterial material) {
		super(material);
    ...
    public boolean hitEntity(ItemStack p_77644_1_, EntityLivingBase target, EntityLivingBase player)
    {
    	...
    	player.addPotionEffect(new PotionEffect(Potion.damageBoost.id, 10));
    	player.addPotionEffect(new PotionEffect(Potion.regeneration.id, 10, 3));
        p_77644_1_.damageItem(1, player);
        return true;
    }
