...
public class RenderZombieCopy extends RenderBiped
{
     ...
     */
    protected int shouldRenderPass(EntityZombieCopy p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
     ...
     */
    public void doRender(EntityZombieCopy p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityZombieCopy p_110775_1_)
    {
        return null; // p_110775_1_ instanceof EntityPigZombie ? zombiePigmanTextures : (p_110775_1_.isVillager() ? zombieVillagerTextures : zombieTextures);
    }

    protected void renderEquippedItems(EntityZombieCopy p_77029_1_, float p_77029_2_)
    {
        this.func_82427_a(p_77029_1_);
        super.renderEquippedItems((EntityLiving)p_77029_1_, p_77029_2_);
    }

    private void func_82427_a(EntityZombieCopy p_82427_1_)
    {
    ...
    protected void rotateCorpse(EntityZombieCopy p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
    ...
    {
        this.renderEquippedItems((EntityZombieCopy)p_77029_1_, p_77029_2_);
    }
    ...
    {
        return this.getEntityTexture((EntityZombieCopy)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityZombieCopy)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        return this.shouldRenderPass((EntityZombieCopy)p_77032_1_, p_77032_2_, p_77032_3_);
    }
    ...
    {
        this.rotateCorpse((EntityZombieCopy)p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);
    }
