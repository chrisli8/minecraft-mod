...
public class EntityZSoilderMob extends EntityZombie {
	
	public EntityZSoilderMob(World par1world) {
		super(par1world);
        ...
        // replaced EntityVillager with EnitityZombie
...
//    	this.dropItem(this.getEquipmentInSlot(4).getItem(), 1);
//    	this.dropItem(this.getEquipmentInSlot(3).getItem(), 1);
    ...
    protected void addRandomArmor()
    {
        ...
        this.setCurrentItemOrArmor(4, new ItemStack(super.getArmorItemForSlot(4, 3)));
        this.setCurrentItemOrArmor(3, new ItemStack(super.getArmorItemForSlot(3, 2)));
        this.setCurrentItemOrArmor(2, new ItemStack(super.getArmorItemForSlot(2, 0)));
        this.setCurrentItemOrArmor(1, new ItemStack(super.getArmorItemForSlot(1, 0)));
    }
...
//        this.getDataWatcher().addObject(13, Byte.valueOf((byte)0)); //villager?
...
//    }
//
//    //protected final methods deleted
//
